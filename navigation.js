...
const PAGE_META = {
  ...
  clientcontacts: { href: "./client-contacts.html", label: "Client Contacts", shortcutLabel: "Contacts" },
...
const MENU_GROUPS = [
  {
    title: "People",
    pages: ["clients", "clientcontacts", "clientdata", "carers", "recruitment", "wellbeingintake", "enquiries", "enquiryremindertest", "suppliers"],
  },
  {
    title: "Planning",
  ...
  },
  {
    ...
    pages: ["emailtemplates", "marketing", "marketingstories", "mastercontacts", "marketingreports", "photolayout", "qrgenerator"],
  },
];
